...
void HiPuRhoProducer::putRho(edm::Event& iEvent,const edm::EventSetup& iSetup)
{
  ...
  std::auto_ptr<std::vector<double>> mapToRhoMedianOut(new std::vector<double>(82,-999.));
  std::auto_ptr<std::vector<double>> mapToRhoExtraOut(new std::vector<double>(82,-999.));
  std::auto_ptr<std::vector<double>> mapToRhoMOut(new std::vector<double>(82,-999.));
  std::auto_ptr<std::vector<int>> mapToNTowOut(new std::vector<int>(82,-999.));
  std::auto_ptr<std::vector<double>> mapToTowExcludePtOut(new std::vector<double>(towExcludePt_.size(),-999.));
  std::auto_ptr<std::vector<double>> mapToTowExcludePhiOut(new std::vector<double>(towExcludePhi_.size(),-999.));
  std::auto_ptr<std::vector<double>> mapToTowExcludeEtaOut(new std::vector<double>(towExcludeEta_.size(),-999.));
  std::auto_ptr<std::vector<double>> ptJetsOut ( new std::vector<double>(0,1e-6));
  std::auto_ptr<std::vector<double>> areaJetsOut ( new std::vector<double>(0,1e-6));
  std::auto_ptr<std::vector<double>> etaJetsOut ( new std::vector<double>(0,1e-6));
  ...
  iEvent.put(mapToRhoMedianOut, "mapToRhoMedian");
  iEvent.put(mapToRhoExtraOut, "mapToRhoExtra");
  iEvent.put(mapToRhoMOut, "mapToRhoM");
  iEvent.put(mapToNTowOut, "mapToNTow");
  iEvent.put(mapToTowExcludePtOut, "mapToTowExcludePt");
  iEvent.put(mapToTowExcludePhiOut, "mapToTowExcludePhi");
  iEvent.put(mapToTowExcludeEtaOut, "mapToTowExcludeEta");
