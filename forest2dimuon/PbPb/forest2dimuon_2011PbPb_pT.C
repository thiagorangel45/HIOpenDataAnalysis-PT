...
void forest2dimuon_2011PbPb_pT(
	...
	dimu_h->Draw("Hist");
        ...
        label.SetTextSize(0.035); label.DrawLatex(0.580, 0.720, "#lbar#eta^{#mu}#lbar < 2.4");//P^{#mu}_{T} > 2.0 GeV
       
        
        label.SetTextSize(0.040); label.DrawLatex(0.460, 0.015, "p_{T}^{#mu#mu}(GeV)");
        
        label.SetTextSize(0.043);  
	label.SetTextAngle(90);  
	label.DrawLatex(0.045, 0.55, "Events/(1 GeV)");
        
	c1->Print("diMuon_Pt_2011_PbPb_1.png");
	//	exit();
} 
