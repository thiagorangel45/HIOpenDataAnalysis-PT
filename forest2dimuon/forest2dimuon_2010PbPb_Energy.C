...
void forest2dimuon_2010PbPb_Energy(
	...
	dimu_h->Draw("Hist");
       ...
       //Label para os dados de 2010 PbPb
        ...
        //label.SetTextSize(0.035); label.DrawLatex(0.580, 0.670, "P^{#mu}_{T} > 3.0 GeV");
	...
	c1->Print("diMuon_Energy_2010_PbPb_1.png");
	//	exit();
} 
