...
void forest2dimuon_2011pp_mass(
	...
	TCanvas *c1 = new TCanvas("c1","DiMuone",1000,1500);
	TH1F *dimu_h = new TH1F("","", 2000, 0.25, 200.25);
	c1->SetLineWidth(20);
	c1->SetTickx(); // Ticks na parte superior do eixo X
        c1->SetTicky(); // Ticks na parte esquerda do eixo y
	...
	dimu_h->Draw("Hist");
        ...
        //Label para os dados de 2011 PbPb
        TLatex label; label.SetNDC(true);
        label.SetTextSize(0.040); label.DrawLatex(0.215, 0.700, "#rho,#omega");
        label.SetTextSize(0.040); label.DrawLatex(0.270, 0.700, "#phi");
        label.SetTextSize(0.040); label.DrawLatex(0.360, 0.800, "J/#psi");
        label.SetTextSize(0.040); label.DrawLatex(0.415, 0.620, "#psi'");
        label.SetTextSize(0.035); label.DrawLatex(0.490, 0.650, "#Upsilon(1,2,3S)");
        label.SetTextFont(42);  
        label.SetTextSize(0.045); label.DrawLatex(0.590, 0.820, "CMS Open Data");
        label.SetTextSize(0.038); label.DrawLatex(0.590, 0.770, "pp 2011 #sqrt{s_{NN}} = 2.76 TeV");
        label.SetTextSize(0.035); label.DrawLatex(0.200, 0.200, "P^{#mu}_{T} > 2.0 GeV");
        label.SetTextSize(0.038); label.DrawLatex(0.590, 0.720, "#lbar#eta#lbar < 2.4");
        label.SetTextSize(0.040); label.DrawLatex(0.460, 0.015, "m_{#mu#mu}(GeV/c^{2})");
        
        label.SetTextSize(0.043);  
	label.SetTextAngle(90);  
	label.DrawLatex(0.045, 0.55, "Events/(0.1 GeV/c^{2})");
        
	c1->Print("diMuon_mass_2011_pp_1.png");
	//	exit();
} 
