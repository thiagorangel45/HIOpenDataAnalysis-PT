...
void forest2dimuon_2011pp_Energy(
	...
	dimu_h->Draw("Hist");
        ...
        label.SetTextSize(0.038); label.DrawLatex(0.580, 0.770, "pp 2011 #sqrt{s_{NN}} = 2.76 TeV");
        //label.SetTextSize(0.035); label.DrawLatex(0.580, 0.670, "P^{#mu}_{T} > 2.0 GeV");
        label.SetTextSize(0.038); label.DrawLatex(0.580, 0.720, "#lbar#eta^{#mu}#lbar < 2.4");
        label.SetTextSize(0.040); label.DrawLatex(0.460, 0.015, "Dimuon energy (GeV)");
        label.SetTextSize(0.043);  
	label.SetTextAngle(90);  
	label.DrawLatex(0.045, 0.55, "Events/(1 GeV)");
       
	c1->Print("diMuon_Energy_2011_pp_1.png");
	//	exit();
} 
