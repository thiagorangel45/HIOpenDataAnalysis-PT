...
void forest2dimuontotalfitPbPb2011(
	...
	RooRealVar NJpsi("NJpsi", "Numero de eventos de J/Psi",0, 220); 
	RooRealVar NPsi2S("NPsi2S", "Numero de eventos de Psi(2S)", 0, 20);
	RooRealVar Nbkg("Nbkg", "Numero de eventos de background", 0, 320);
