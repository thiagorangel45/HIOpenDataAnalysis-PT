...
void forest2dimuon_2010PbPb_mass(
	...
	dimu_h->Draw("Hist");
       ...
       //Label para os dados de 2010 PbPb
        ...
        label.SetTextSize(0.035); label.DrawLatex(0.200, 0.200, "P^{#mu}_{T} > 3.0 GeV");
        label.SetTextSize(0.038); label.DrawLatex(0.580, 0.720, "#lbar#eta#lbar < 2.4");
